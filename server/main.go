...
func main() {
	...
	r.HandleFunc("/upload/{id}/{filename}", fileUpload).Methods("GET", "OPTIONS")
	r.HandleFunc("/download/{id}/{filename}", filedownloader).Methods("GET", "OPTIONS")
	r.HandleFunc("/{id}/{filename}", deleteFile).Methods("DELETE", "OPTIONS")
